    ...
    >
      <span className="theme-toggle-track">
        <span className="theme-toggle-thumb">
          {isLight ? (
            <svg key="sun" className="theme-toggle-icon" viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
              <circle cx="12" cy="12" r="4.5" />
              <path d="M12 2.5v2M12 19.5v2M4.6 4.6l1.4 1.4M18 18l1.4 1.4M2.5 12h2M19.5 12h2M4.6 19.4l1.4-1.4M18 6l1.4-1.4" />
            </svg>
          ) : (
            <svg key="moon" className="theme-toggle-icon" viewBox="0 0 24 24" width="13" height="13" fill="currentColor">
